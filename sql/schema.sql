...
-- Required server version is 5.0.45 or better
...
DROP TABLE IF EXISTS `user_article_comment`;
...
--
-- Table structure for table `user_article_details`
--

DROP TABLE IF EXISTS `user_article_details`;
