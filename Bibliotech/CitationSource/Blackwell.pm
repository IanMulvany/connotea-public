...
sub understands {
  ...
  # ex.
  # http://www.blackwell-synergy.com/servlet/useragent?func=synergy&synergyAction=showAbstract&doi=10.1046/j.1365-2486.2002.00492.x
...
sub citations {
  ...
  eval {
	...
	if($res->is_success) {
		...
		$ris = new Bibliotech::CitationSource::NPG::RIS ($res->content);
		die "RIS obj false\n" unless $ris;
