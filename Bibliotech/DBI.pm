...
require Bibliotech::DBI::Article;
require Bibliotech::DBI::Unwritten::Article;
require Bibliotech::DBI::User_Article;
require Bibliotech::DBI::Unwritten::User_Article;
require Bibliotech::DBI::User_Article_Tag;
require Bibliotech::DBI::User_Article_Details;
require Bibliotech::DBI::User_Article_Comment;
